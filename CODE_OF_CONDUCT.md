...
- Submitting extensions containing malicious code, hidden tracking, or deliberately
  misleading metadata
...
code, issues, submitted extension packages, and other contributions that are not aligned to
this Code of Conduct.

## Scope

This Code of Conduct applies within all community spaces, including issues, pull requests,
discussions, and submitted extension packages. It also applies when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainers by opening a private security advisory on the repository, or by contacting the
repository owner directly. All complaints will be reviewed and investigated promptly and
fairly.
...
2. **Warning:** A warning with consequences for continued behavior, including a specified
